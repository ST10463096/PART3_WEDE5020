...
// This creates a search button that takes you to the matching page/section

document.addEventListener('DOMContentLoaded', function() {
    // Check if we're on a page that has a search input
    const searchInput = document.getElementById('liveSearch');
    
    if (searchInput) {
        // Create the search button if it doesn't exist
        let searchBtn = document.getElementById('searchNavigateBtn');
        ...
        if (!searchBtn) {
            ...
            if (searchContainer) {
                ...
                searchBtn.id = 'searchNavigateBtn';
                searchBtn.innerHTML = '<i class="bx bx-search-alt"></i> Search & Go';
        ...
        // Search navigation data - maps search terms to URLs
        const searchNavigationMap = [
            // Services - exact matches
            { keywords: ["web development", "website", "web design", "websites", "web dev"], url: "services.html", anchor: "webdev", highlight: "Web Development" },
            { keywords: ["it support", "support", "tech support", "computer support", "it help"], url: "services.html", anchor: "support", highlight: "IT Support" },
            { keywords: ["network", "networking", "wi-fi", "wifi", "wireless", "network solutions"], url: "services.html", anchor: "network", highlight: "Network Solutions" },
            { keywords: ["cybersecurity", "security", "cyber", "data protection", "hacking", "threat"], url: "services.html", anchor: "cyber", highlight: "Cybersecurity" },
            { keywords: ["cloud", "cloud security", "cloud services", "azure", "aws", "google cloud"], url: "services.html", anchor: "cloud", highlight: "Cloud Security" },
            { keywords: ["data", "analytics", "business intelligence", "data analytics", "bi"], url: "services.html", anchor: "analytics", highlight: "Data & Analytics" },
            { keywords: ["hardware", "setup", "computer setup", "hardware setup", "installation"], url: "services.html", anchor: "hardware", highlight: "Hardware Setup" },
            { keywords: ["repair", "repairs", "fix computer", "troubleshooting", "virus removal"], url: "services.html", anchor: "repair", highlight: "IT Support & Repairs" },
            { keywords: ["maintenance", "system maintenance", "updates", "backup"], url: "services.html", anchor: "maintenance", highlight: "Maintenance" },
            { keywords: ["remote", "remote support", "remote assistance", "online support"], url: "services.html", anchor: "remote", highlight: "Remote Support" },
            
            // Pages
            { keywords: ["home", "main", "homepage"], url: "index.html", anchor: null, highlight: "Home" },
            { keywords: ["about", "about us", "company", "who we are"], url: "about_us.html", anchor: null, highlight: "About Us" },
            { keywords: ["contact", "call", "phone", "email", "address", "location", "reach us"], url: "contact_us.html", anchor: "contact", highlight: "Contact Us" },
            { keywords: ["enquiry", "enquiries", "ask", "question", "help", "support form"], url: "enquiries.html", anchor: "enquiry", highlight: "Enquiry Form" },
            { keywords: ["career", "careers", "job", "work", "employment", "apply", "join"], url: "careers.html", anchor: null, highlight: "Careers" },
            { keywords: ["blog", "articles", "news", "updates", "tech news"], url: "blog.html", anchor: null, highlight: "Blog" },
            { keywords: ["portal", "client portal", "dashboard", "account", "login"], url: "client-portal.html", anchor: null, highlight: "Client Portal" },
            
            // Pricing/Plans
            { keywords: ["price", "pricing", "cost", "package", "plan", "starter", "professional", "enterprise", "rates"], url: "services.html#pricing", anchor: "pricing", highlight: "Pricing Plans" },
            
            // Specific services from the services page
            { keywords: ["cyber security services", "threat detection", "penetration testing", "incident response"], url: "services.html", anchor: "cyber", highlight: "Cyber Security Services" },
            { keywords: ["cloud security services", "zero trust", "compliance", "encryption"], url: "services.html", anchor: "cloud", highlight: "Cloud Security" },
            { keywords: ["hardware setup services", "computer installation", "server setup", "printer setup"], url: "services.html", anchor: "hardware", highlight: "Hardware Setup" },
            { keywords: ["wi-fi network services", "router config", "mesh system", "vlan"], url: "services.html", anchor: "network", highlight: "Wi-Fi & Network" },
            { keywords: ["website design services", "responsive website", "seo friendly", "custom design"], url: "services.html", anchor: "webdev", highlight: "Website Design" },
            { keywords: ["maintenance services", "software update", "security patch", "performance optimization"], url: "services.html", anchor: "maintenance", highlight: "Maintenance" },
            { keywords: ["remote support services", "remote assistance", "online troubleshooting"], url: "services.html", anchor: "remote", highlight: "Remote Support" },
            
            // Contact page specific
            { keywords: ["phone number", "call us", "telephone", "landline"], url: "contact_us.html", anchor: "phone", highlight: "Phone Number" },
            { keywords: ["email address", "email us", "send email", "info@", "support@"], url: "contact_us.html", anchor: "email", highlight: "Email Address" },
            { keywords: ["office address", "visit us", "location", "arcadia", "pretoria", "loftus"], url: "contact_us.html", anchor: "address", highlight: "Office Address" },
            { keywords: ["office hours", "business hours", "opening hours", "when are you open"], url: "contact_us.html", anchor: "hours", highlight: "Office Hours" },
            { keywords: ["whatsapp", "whatsapp number", "whatsapp chat"], url: "contact_us.html", anchor: "whatsapp", highlight: "WhatsApp" },
            { keywords: ["facebook", "instagram", "tiktok", "youtube", "linkedin", "social media"], url: "contact_us.html", anchor: "social", highlight: "Social Media" }
        ];
        
        // Function to find matching result
        function findMatchingSearch(query) {
            const lowerQuery = query.toLowerCase().trim();
            
            // Check for exact matches first
            for (let item of searchNavigationMap) {
            ...
            // Then check for partial matches (best match)
            let bestMatch = null;
            ...
            for (let item of searchNavigationMap) {
                for (let keyword of item.keywords) {
                    if (lowerQuery.includes(keyword.toLowerCase()) || keyword.toLowerCase().includes(lowerQuery)) {
                        // Calculate match score (longer keyword match is better)
                        const score = Math.min(keyword.length, lowerQuery.length);
        ...
        function navigateToSearch() {
            ...
            if (!query) {
                // Show notification to enter search term
                showSearchNotification("Please enter what you're looking for", "warning");
                return;
            }
            ...
            const match = findMatchingSearch(query);
            
            if (match) {
                // Show success notification
                showSearchNotification(`✓ Found: ${match.highlight}. Redirecting...`, "success");
        ...
        function showSearchNotification(message, type) {
            ...
            `;
            notif.innerHTML = `<i class='bx ${type === 'success' ? 'bx-check-circle' : type === 'warning' ? 'bx-error-circle' : 'bx-info-circle'}'></i> ${message}`;
        ...
        // Function to show suggestions when no match found
        function showNoResultsSuggestions(query) {
            // Find related suggestions
            const suggestions = [];
            for (let item of searchNavigationMap) {
                for (let keyword of item.keywords) {
                    if (keyword.includes(query.toLowerCase()) || query.toLowerCase().includes(keyword.substring(0, 3))) {
                        if (!suggestions.includes(item.highlight)) {
                            suggestions.push(item.highlight);
                        }
                        break;
                    }
                }
            ...
            if (topSuggestions.length > 0) {
                message += `<br><small>Did you mean: ${topSuggestions.join(', ')}?</small>`;
            } else {
                message += `<br><small>Try: Web Development, IT Support, Cybersecurity, Contact Us, Careers</small>`;
            }
            
            showSearchNotification(message, "error");
        }
        
        // Get or create the search button
        const navigateBtn = document.getElementById('searchNavigateBtn');
        if (navigateBtn) {
        ...
        // Also allow Enter key to trigger navigation
        if (searchInput) {
        ...
        if (!document.getElementById('searchAnimStyles')) {
            const style = document.createElement('style');
            style.id = 'searchAnimStyles';
            style.textContent = `
                @keyframes slideInRight {
                    from { transform: translateX(100%); opacity: 0; }
                    to { transform: translateX(0); opacity: 1; }
